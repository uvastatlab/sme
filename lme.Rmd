...
block <- list("1"=eggprod[eggprod$block=="1","eggs"], 
              "2"=eggprod[eggprod$block=="2","eggs"],
              "3"=eggprod[eggprod$block=="3","eggs"],
              "4"=eggprod[eggprod$block=="4","eggs"])
...
# ggplot2
library(ggplot2)
ggplot(eggprod, aes(x=treat, y=eggs)) + 
