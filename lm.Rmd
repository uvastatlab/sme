...
For this in particular, values seems generally centered around mostly horizontal line @ 0. Good amount of spread above 0. Does this mean the model is not so good? Perhaps need to look at other things
