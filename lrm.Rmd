...
This shows that the model including age is a slightly better fit than the null model (intercept only). The model including both age and log(ab) is a better fit ($\chi^2(1,100) = 15.63, p < .001$) than the model only containing age. In general, a predictor that contributes to a model will reduce deviance by more than 1 or 2 units.
