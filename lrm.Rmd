...
The data is available as ".txt" file. Below we import the data using the `read.table()` function with `header=TRUE` since the first row contains column header names. We then select columns we want to analyze and set convert all the variable names to lower case for convenience. 
