...
Add a column of log transformed antibody values to data frame instead of log transforming on-the-fly and then refit the model. This helps us create an effect plot.
...
Now we can create an effect plot for "logab" as follows using the ggpredict() function from the ggeffects package. This is basically predicted probabilities of malaria over the range of observed log antibody levels, holding age at its mean level (in this case, around 9).
